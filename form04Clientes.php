      ...
      <tr style="vertical-align: middle;">
        <td><table style= "width: 100%;">
            <tr>
              ...
              <td style="text-align: left; "> buscar: &nbsp;
                <input type="text" name="pbusc" value="ingresar" style="width: 120px;" class="textCaracteristicas"/>
              </td>
              <td style="text-align: right;" ><input type="button" name="pNuevo" value="Agregar"
...
<h1> Actualizar CC</h1><br />

		Entrega: &nbsp;<input type="text" name="pbusc" value="ingresar" style="width: 120px;" class="textCaracteristicas"/><br /><br />

<input type="button" name="pNuevo" value="Buscar" class="buttonClientes" /><br />
<br />
</td>
      	</tr></table>
		</td>
