...
<table class="tablaClientes">
	<tr style="height:180px;">
				...
				<tr style="vertical-align: middle;">
					<td>
						...
						<div class="scrolEmpleado">
							<table class="formuClientes" style="width: 100%;">
		...
		<td style="height:30px; text-align: right;">
			...
			<br />
			<br />
			<input type="button" name="pNuevo" value="Agregar" class="buttonClientes" />
			<br />
			<br />
			<input type="button" name="pNuevo" value="Modificar" class="buttonClientes" disabled="yes" />
		</td>
	</tr>
</table>
<br />
			...
			<td>
				<table class="formuClientes" style="width:800px">
					...
					<tr style="text-align: center;">
						...
						<td>
							<a title='Modificar datos'><img src='imagenes/iconos/retorno.png' width='14' height='14' /></a>
						</td>
						<td>
							<a title='Borrar'><img src='imagenes/iconos/descarga.jpg' width='14' height='14' /></a>
						</td>
						<td>
							Comba 3/4
						</td>
