		...
		<div class="col-md-12">
			<div class="panel panel-success">
                ...
                <div class="col-md-5" style="text-align: right; padding-bottom: 10px;">
                    ...
                    <div class="col-md-2" >
                    <a href="#prenda">	<input type="button" value="Nuevo" style="width: 100px;" class="buttonPrendasNueva btn btn-sm btn-success" /></a>
				</div>
                <div class="row">
					<table class="tabla">
						<tr>
												...
												<?php $cont=0; if (isset($prendas)){ foreach ($prendas as $prenda) { $cont++; ?>
													<tr id="<?php echo $cont;?>" class="<?php echo $cont;?>" >
														<td style="text-align: center;" onclick=" pintafila(<?php echo $cont;?>,'#FF0000')">
															...
															data-valor5="<?php echo $prenda['valor5']?>" data-valor6="<?php echo $prenda['valor6']?>"  />
															<img src='./imagenes/iconos/layout_edit.png' width='18px' height='18px' />
															</a>
														</td>
														<td style="text-align: center;" onclick=" pintafila(<?php echo $cont;?>,'#FFff00')">
